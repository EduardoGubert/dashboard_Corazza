...
const supabaseUrl = (window as any)._env_?.REACT_APP_SUPABASE_URL || process.env.REACT_APP_SUPABASE_URL as string;
const supabaseAnonKey = (window as any)._env_?.REACT_APP_SUPABASE_ANON_KEY || process.env.REACT_APP_SUPABASE_ANON_KEY as string;
